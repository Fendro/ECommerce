...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        let error_msg = "";
        if (email < 6) error_msg += "Email must be at least 6 characters long";
        if (username < 6) error_msg += "Username must be at least 6 characters long";
        if (password < 6) error_msg += "Password must be at least 6 characters long";
