...
import {AnyImage, CenteredContainer, FormContainer, StyledInput, TopCenterContainer} from '../styling';
    ...
    return (<>
        <TopCenterContainer>
            ...
            <Button variant="outlined" color="success"
                    onClick={() => handleAddUser()}><PersonAddAlt1RoundedIcon/></Button>
        </TopCenterContainer>
        ...
        <form onSubmit={handleSubmit}>
            <CenteredContainer>
                <FormContainer>
                    ...
                    <StyledInput ref={inputShortDesc} type="text" placeholder="Short description" fullWidth
                                 required/>
